          ...
          <form  method ='POST' action ="">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class ="form-group">
                <label> Alamat</label>
                  <textarea type="text" name="alamat" class="form-control"rows="5" required="" autofocus="" data-errormessage-value-missing='Alamat masih kosong'></textarea>
                </div>
                </div>
                <div class="col-md-6">
                <div class ="form-group">
            ...
            <div class ="form-group">
              ...
              <div class="col-md-6">
              <div class ="form-group">
                <div><label for="jk" class="form-control"required="" autofocus="" data-errormessage-value-missing='Jenis Kelamin masih kosong'>Jenis Kelamin </label>
